...
\begin{tikzpicture}[>=stealth,decoration={
	...
	\node[circle,fill=red,inner sep=0pt,minimum size=3pt] (n13) at (2,5) {};

  \node[below=-3pt of n13,red] (n) {$v'$};

	\node[circle,fill=red,inner sep=0pt,minimum size=2pt] (n14) at (3,5) {};
	\node[circle,fill=red,inner sep=0pt,minimum size=2pt] (n15) at (3,6) {};
	\node[circle,fill=red,inner sep=0pt,minimum size=2pt] (n16) at (2,6) {};

	\draw[postaction={decorate}] (n6) --node[below right=-3pt]{$a$} (n13);
	\draw[postaction={decorate},red] (n13) --node[below=-2pt]{$a$} (n14);
	\draw[postaction={decorate},red] (n14) --node[right=-2pt]{$b$} (n15);
	\draw[postaction={decorate},red] (n13) --node[left=-2pt]{$b$} (n16);
	\draw[postaction={decorate},red] (n16) --node[above=-2pt]{$a$} (n15);
\end{tikzpicture}
\end{document}
