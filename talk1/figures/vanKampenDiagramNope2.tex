...
\begin{tikzpicture}[>=stealth,decoration={
  ...
  \node[circle,fill=black,inner sep=0pt,minimum size=2pt] (m1) at (0,1.5) {};
	\node[circle,fill=black,inner sep=0pt,minimum size=2pt] (m2) at (0.5,2) {};
	\node[circle,fill=black,inner sep=0pt,minimum size=2pt] (m3) at (0,2.5) {};
	\node[circle,fill=black,inner sep=0pt,minimum size=2pt] (m4) at (-0.5,2) {};
	
  \draw[postaction={decorate}] (n1) --node[above right=-3pt]{$a$} (m1);
	\draw[postaction={decorate}] (m1) --node[below right=-5pt]{$a$} (m2);
	\draw[postaction={decorate}] (m2) --node[above right=-4pt]{$b$} (m3);
	\draw[postaction={decorate}] (m4) --node[above left=-5pt]{$a$} (m3);
	\draw[postaction={decorate}] (m1) --node[below left=-5pt]{$b$} (m4);
